  ...
  class _JiraIssuesListState extends State<JiraIssuesList> {
    ...
    Future<List<Issue>?> getIssues() async {
      ...
      var response = await http.get(uri, headers: JiraAuth.headers);
    ...
    Future deleteIssue(String issueKey) async {
      ...
      var deleteRequest = await http.delete(deleteUrl, headers: JiraAuth.headers);
